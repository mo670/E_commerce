<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
      <a class="moutusi online shop" href="index.html"><img src="Admin/assets/images/logo.svg" alt="logo" /></a>
      <h1 style= "font-wight:bold">Moutusi online shop</h1>
        ...
        <div class="profile-desc">
          <div class="profile-pic">
            ...
            <div class="profile-name">
              <h5 class="mb-0 font-weight-normal">Moutusi</h5>
              <span>Admin</span>
            </div>
          </div>
      ...
      <li class="nav-item menu-items">
        ...
        <div class="collapse" id="ui-basic">
          <ul class="nav flex-column sub-menu">
            ...
            <li class="nav-item"> <a class="nav-link" href="{{url('show_Product')}}">Product List</a></li>
